...
class SavdhanBackPostureRule(EvaluationRule):
...
class SavdhanBodyPostureRule(EvaluationRule):
...
class SavdhanShoulderLevelRule(EvaluationRule):
    name = "Shoulder level"
...
class SavdhanHeadAlignmentRule(EvaluationRule):
    name = "Head alignment"
