...
class VishramBackPostureRule(EvaluationRule):
...
class VishramBodyPostureRule(EvaluationRule):
...
class VishramShoulderLevelRule(EvaluationRule):
    name = "Shoulder level"
...
class VishramHeadAlignmentRule(EvaluationRule):
    name = "Head alignment"
